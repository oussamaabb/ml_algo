...
# what we test
#the mean of the data is a linear function of the explanatory variable(s)*; eg:This assumes that there is a linear relationship 
#between the predictors (e.g. independent variables or features) and the response variable (e.g. dependent variable or label). 
...
#opttional valid for interpertability : No Multicollinearity among Predictors
